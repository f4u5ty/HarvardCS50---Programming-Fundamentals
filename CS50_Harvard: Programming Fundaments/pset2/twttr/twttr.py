...
def vowel_del():
    ...
    i = 0
    while i < len(tweet):
        if tweet[i] in vowels:
            replaced_tweet = replaced_tweet.replace(tweet[i],"") #this is the most important line of code.
        i+=1                                                     #updates tweet, so that deleted letters stay deleted.
    tweet = replaced_tweet
...
"""
We need to iterate through a phrase for vowels. We can get rid of the vowels once.
"""
