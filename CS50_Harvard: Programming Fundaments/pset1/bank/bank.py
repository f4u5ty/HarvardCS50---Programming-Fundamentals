...
def bank_greet(greeting = str):
    greeting = input("Please enter a greeting: ")
    greeting = greeting.lower().strip()         #strips whitespace, gets rid of capitalization
    if "hello" in greeting:                     #if greeting is hello, awards zero dollars, uses "in" to check. 
        print("$0")

    elif (greeting[0] == "h") and (greeting != "hello"): #if greeting begins with h and is not hello, awards $20 dollars.
        print("$20")
